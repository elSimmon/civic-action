        ...
        <div class="row">
            <div class="col-md-4 col-lg-4">
                <div class="copyright-widget mt10 mb15-767">
                    <p>© Civic Action Hub - All rights reserved.</p>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="footer_logo_widget text-center mb15-767">
                    <div class="wrapper">
                        <div class="logo text-center">
                            <img src="{{asset('guido/images/footer-logo.svg')}}" alt="footer-logo.svg">
                            <span class="logo_title text-white pl15">Civic Action Africa</span>
                        </div>
                    </div>
                </div>
            </div>
